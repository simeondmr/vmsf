...
void dump_ram_32(uint8_t *ram)
{
	uint32_t i;
	printf("ram (32b): ");
	for(i = 0 ; i < RAM_SIZE_BYTE ; i += 4) {
		printf("[%d]=0x%08x ", i, read_ram_32(ram, i));
	}
	printf("\n");
}
